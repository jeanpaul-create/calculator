...
/**
 * Screen 4 data — cumulative cost of electricity WITHOUT the installation vs
 * WITH it (investment paid year 0, then the residual bill). Both series use
 * the same retail-escalation assumption as calculateRoi, so the curves cross
 * exactly at the payback point shown on Screen 3.
 *
 ...
 */
function buildDoNothing(s: PricedScenario): PresentVM['doNothing'] {
