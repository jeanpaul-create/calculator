        ...
        <nav className="flex-1 px-2 py-4 space-y-1 overflow-y-auto md:px-1 lg:px-2">
          ...
          {role === 'ADMIN' && (
            <>
              ...
              <NavItem href="/admin/approvals" isActive={isActive('/admin/approvals')} onClick={onMobileClose} title="Approbations">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="md:hidden lg:inline">Approbations</span>
              </NavItem>
